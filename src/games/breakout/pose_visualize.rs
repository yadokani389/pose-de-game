...
pub(super) fn create_image(mut commands: Commands, mut images: ResMut<Assets<Image>>) {
    let extent = Extent3d {
        width: 1000,
        height: 1000,
    ...
    commands.spawn((
        ...
        PersonImage,
        DespawnOnExit(AppState::Breakout),
    ));
...
pub(super) fn show_right_hand(people: Res<PeopleDataRes>, mut gizmos: Gizmos) {
...
pub(super) fn show_person_image(
...
pub(super) fn show_person_enabled(args: Res<Args>) -> bool {
    args.show_person
}
